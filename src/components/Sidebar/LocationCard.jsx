    ...
    >
      <div style={{ padding:'12px 14px', display:'flex', flexDirection:'column', gap:8 }}>
        <div style={{ display:'flex', alignItems:'flex-start', gap:10 }}>
          ...
          {/* Avatar cuadrado — imagen si tiene, iniciales si no */}
          {loc.image_url ? (
            <div style={{ width:48, height:48, borderRadius:'var(--r-sm)', overflow:'hidden', flexShrink:0, border:'1px solid rgba(255,255,255,0.1)' }}>
